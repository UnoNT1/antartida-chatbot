    ...
    **Presenta la siguiente pregunta paraa obtener el equipo sobre el cual se genera el reclamo**
    ...
    if(respuesta.includes('1') && vuelta === 0) {
        ...
        Que equipo presenta problemas?
            ...
            - D --> Portero electrico fuera de servicio

            - E --> Problemas electricos
            
            - F --> Problemas con la Bomba de Agua

            - G --> Otros problemas (Ejemplo: ruido en viaje, no funciona un botón, objetos caídos en pozo, falta de iluminación, no funciona llavero magnético, etc.)IMPORTANTE**al elegir esta opcion, debes reconocer o preguntar por el equipo sobre el cual esta generando el reclamo el usuario(Ascensor, Montavehiculos)
        ...
        **
        ...
        if(respuesta.includes('A') || respuesta.includes('B') || respuesta.includes('1') || respuesta.includes('2')) {
            ...
            **Al aparecer estas preguntas significa que Se eligio el equipo Porton Corredizo/Elevadizo** 
            ...
            return prompt;
        }else if(respuesta.includes('E') || respuesta.includes('5') || respuesta.includes('D') || respuesta.includes('4')) {
            prompt += ` 
            **Al aparecer estas preguntas significa que Se eligio el equipo Portero Electrico o Problemas electricos** 
            Hubo baja de tensión o corte de luz reciéntemente?
