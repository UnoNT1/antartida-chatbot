    ...
    **Presenta la siguiente pregunta paraa obtener el equipo sobre el cual se genera el reclamo**
    ...
    if(respuesta.includes('1') && vuelta === 0) {
        ...
        Que equipo presenta problemas?
            ...
            - C --> Otros problemas (Ejemplo: ruido en viaje, no funciona un botón, objetos caídos en pozo, falta de iluminación, no funciona llavero magnético, etc.)IMPORTANTE**al elegir esta opcion, debes reconocer o preguntar por el equipo sobre el cual esta generando el reclamo el usuario(Ascensor, Montavehiculos)`
    ...
    if((opcion === 1 && vuelta === 1) || (opcion === 2 && vuelta === 2)) {
        ...
        **Siguiente paso: Solicitar dirección o nombre del edificio**
            ...
            **Paso 1.2: Comparar dirección o nombre con la lista**
            ...
            Si no Encuenntras coincidencia carga en el parametro 'Direccion' y 'Edificio' la direccion proporcionada por el Usuario.
